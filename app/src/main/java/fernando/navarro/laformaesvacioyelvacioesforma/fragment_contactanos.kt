package fernando.navarro.laformaesvacioyelvacioesforma
...
class fragment_contactanos : Fragment() {
    ...
    override fun onCreateView(
        ...
        val correo = root.findViewById<Button>(R.id.btnCorreo)
        correo.setOnClickListener {
        Toast.makeText(requireContext(), "Mi codigo es 20230531", Toast.LENGTH_SHORT).show()
        }
        return root
    }
